...
court_graph = st.Page('pages/court_graph.py', title='court_graph')

pg = st.navigation([court_graph,start_page, data_page, score_page, w_point_type_page, l_point_type_page, w_player_page, l_player_page, w_court_page, l_court_opp_point_page, l_court_team_error_page], position='sidebar')
